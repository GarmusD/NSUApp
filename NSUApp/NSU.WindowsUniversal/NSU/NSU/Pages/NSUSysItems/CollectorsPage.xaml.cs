...
namespace NSU.NSU_UWP.Pages.NSUSysItems
{
    ...
    /// </summary>
    public sealed partial class CollectorsPage : Page
    {
        public CollectorsViewModel CollectorsData { get; private set; }
        public CollectorsPage()
        {
            ...
            CollectorsData = DataCollections.Current.CollectorsVM;
        }
    }
}
