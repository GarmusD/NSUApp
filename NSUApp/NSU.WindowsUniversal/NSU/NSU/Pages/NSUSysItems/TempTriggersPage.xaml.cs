...
namespace NSU.NSU_UWP.Pages.NSUSysItems
{
    ...
    /// </summary>
    public sealed partial class TempTriggersPage : Page
    {
        public TempTriggersViewModel TempTriggersData { get; set; }

        public TempTriggersPage()
        {
            ...
            TempTriggersData = DataCollections.Current.TempTriggersVM;
        }
    }
}
