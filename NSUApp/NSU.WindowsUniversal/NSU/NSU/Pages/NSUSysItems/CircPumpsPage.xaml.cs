...
namespace NSU.NSU_UWP.Pages.NSUSysItems
{
    ...
    /// </summary>
    public sealed partial class CircPumpsPage : Page
    {
        public CircPumpsViewModel CircPumpsData { get; private set; }

        public CircPumpsPage()
        {
            ...
            CircPumpsData = DataCollections.Current.CircPumpsVM;
        }
    }
}
